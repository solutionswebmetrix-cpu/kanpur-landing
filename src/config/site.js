...
export const SOLAR_SERVICES = [
  ...
  ["Commercial Solar", "commercial-solar", "Custom solar solutions for shops, offices, hotels, restaurants, commercial buildings.", ["High ROI", "Custom Design", "Fast Installation", "Energy Storage"], "fa-building", IMG_SOLAR_COMMERCIAL],
  ["Industrial Solar", "industrial-solar", "Large-scale solar power plants for factories, industries and manufacturing units.", ["High Capacity", "Industrial Grade", "24/7 Power", "Grid Integration"], "fa-industry", IMG_SOLAR_INDUSTRIAL],
  ["On Grid Solar System", "on-grid-solar", "Grid-tied solar systems that feed excess energy to the grid.", ["Net Metering", "Lower Bills", "No Battery", "Government Subsidy"], "fa-plug", IMG_SOLAR_STORAGE],
  ["Off Grid Solar System", "off-grid-solar", "Standalone solar systems with battery backup for remote areas.", ["Power Backup", "No Grid", "Energy Independence", "Rural Friendly"], "fa-battery-full", IMG_SOLAR_OFFGRID],
  ["Hybrid Solar System", "hybrid-solar", "Combination of on-grid and off-grid for maximum efficiency.", ["Both Grid + Battery", "24/7 Power", "Smart Management", "Backup Option"], "fa-sync", IMG_SOLAR_HYBRID],
  ["PM Surya Ghar Solar", "pm-surya-ghar", "Avail up to ₹78,000 government subsidy on rooftop solar.", ["Govt Subsidy", "300 Units Free", "Authorized Vendor", "Complete Paperwork"], "fa-sun", IMG_SOLAR_COMMERCIAL],
  ["Solar Panel Installation", "solar-panel-installation", "Professional solar panel installation with precision.", ["Expert Installation", "Safety Standards", "Quality Panels", "After Service"], "fa-solar-panel", IMG_SOLAR_HOME],
  ["Solar Water Pump", "solar-water-pump", "Solar-powered water pumps for irrigation and domestic use.", ["Low Running Cost", "Govt Subsidy", "Rural Friendly", "Low Maintenance"], "fa-water", IMG_SOLAR_INDUSTRIAL],
  ["Solar Atta Chakki", "solar-atta-chakki", "Solar-powered flour mills for villages and homes.", ["Cost Effective", "Rural Friendly", "Low Maintenance", "Govt Subsidy"], "fa-bread-slice", IMG_SOLAR_INDUSTRIAL],
  ["Solar Street Light", "solar-street-light", "Standalone solar street lights with auto-on/off.", ["No Grid", "Low Maintenance", "Durable", "Energy Saving"], "fa-lightbulb", IMG_SOLAR_HOME],
  ["Solar Water Heater", "solar-water-heater", "Solar-powered water heaters for homes and commercial use.", ["Hot Water 24/7", "Energy Saving", "Low Maintenance", "Durable"], "fa-shower", IMG_SOLAR_HOME],
  ["Solar Battery", "solar-battery", "High-capacity lithium-ion and tubular solar batteries.", ["Long Life", "Fast Charging", "Low Maintenance", "Warranty"], "fa-battery-three-quarters", IMG_SOLAR_STORAGE],
  ["Solar Inverter", "solar-inverter", "Premium solar hybrid and PCU with MPPT and PCU.", ["Pure Sine Wave", "MPPT Technology", "High Efficiency", "Smart Display"], "fa-bolt", IMG_SOLAR_STORAGE],
  ...
  ["Solar Structure", "solar-structure", "Strong and durable solar panel mounting structures.", ["Custom Design", "Weather Resistant", "Wind Proof", "Corrosion Free"], "fa-screwdriver-wrench", IMG_SOLAR_HOME],
  ["Net Metering", "net-metering", "Net metering setup and documentation.", ["Full Documentation", "DISCOM Approval", "Quick Installation", "After-Sales Support"], "fa-route", IMG_SOLAR_INDUSTRIAL],
  ["Solar Subsidy Assistance", "solar-subsidy-assistance", "Complete help with solar subsidy application.", ["Paperwork Handling", "Govt Liaison", "Quick Approval", "Authorized Partner"], "fa-hand-holding-dollar", IMG_SOLAR_COMMERCIAL],
];
...
export const SOLAR_TYPES = [
  ["On Grid", "On-grid solar systems are connected to the electricity grid. Excess energy is sent to grid and you get credit via net metering.", "Best for: Homes & businesses with regular grid supply", ["Net metering", "Lower electricity bills", "No battery required", "Low maintenance"], "₹45,000 to ₹65,000", "fa-plug"],
