...
export const SOLAR_TYPES = [
  ...
  ["Commercial Solar", "Commercial solar systems are specially designed for offices, factories, schools, hospitals, warehouses and commercial buildings to significantly reduce electricity costs while ensuring long-term energy savings.", "Best for: Factories, Commercial Buildings, Schools, Hospitals, Offices, Warehouses", ["High Power Generation", "Lower Electricity Bills", "Net Metering Support", "Scalable System", "Low Maintenance", "25–30 Years Warranty"], "₹45,000 to ₹55,000", "fa-building"],
];
